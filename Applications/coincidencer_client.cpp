...
int main(int argc, char *argv[]) {
  try {
    ...
    try {
      ...
      client_socket << "6.75968 5500778 352.05  3       2       0.360012       "
                       " 6       5500778 5500780\r\n";
      std::cerr << "6.75968 5500778 352.05  3       2       0.360012        6  "
                   "     5500778 5500780"
                << endl;
      sleep(1);

      client_socket << "7.39276 5550148 355.209 4       1       0.180007       "
                       " 10      5550144 5550156\r\n";
      std::cerr << "7.39276 5550148 355.209 4       1       0.180007        10 "
                   "     5550144 5550156"
                << endl;
      sleep(1);
      /*
              ...
              client_socket << "6.75968 5500778 352.05  3       2       0.360012
         6       5500778 5500780\r\n"; std::cerr << "6.75968 5500778 352.05  3
         2       0.360012        6       5500778 5500780\r\n"; sleep(1);

              client_socket << "7.39276 5550148 355.209 4       1       0.180007
         10      5550144 5550156\r\n"; std::cerr << "7.39276 5550148 355.209 4
         1       0.180007        10      5550144 5550156\r\n"; sleep(1);
              */
