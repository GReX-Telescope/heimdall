...
#ifndef ARE_COINCIDENT_CUH
#define ARE_COINCIDENT_CUH
...
inline __host__ __device__ bool
are_coincident(hd_size samp_i, hd_size samp_j, hd_size begin_i, hd_size begin_j,
               hd_size end_i, hd_size end_j, hd_size filter_i, hd_size filter_j,
               hd_size dm_i, hd_size dm_j, hd_size time_tol, hd_size filter_tol,
               hd_size dm_tol) {
